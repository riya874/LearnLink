                ...
                <div className="mt-6 border-t pt-6">
                    ...
                    {isEditingParent ? (
                        <form onSubmit={handleParentUpdate}>
                            ...
                            {/* Children's Grade - Radio Buttons */}
                            <label>Children's Grade</label>
                            <div className="flex items-center gap-2 border p-1 w-full mb-2">
                                <FaGraduationCap />
                                <div className="flex gap-4">
                                    {["1st","2nd","3rd","4th","5th", "6th", "7th", "8th", "9th", "10th"].map((grade, index) => (
                                        <div key={index} className="flex items-center gap-2">
                                            <input
                                                ...
                                                name="grade"
                                                value={grade}
                                                checked={parentInfo.children.grade === grade}
                            ...
                            {/* Teaching Style - Radio Buttons */}
                            <label>Teaching Style</label>
                            <div className="flex items-center gap-2 border p-1 w-full mb-2">
                                <FaChalkboard />
                                <div className="flex gap-4">
                                    {["Online", "In-person"].map((style, index) => (
                                        <div key={index} className="flex items-center gap-2">
                                            <input
                                                type="radio"
                                                id={style}
                                                name="teachingStyle"
                                                value={style}
                                                checked={parentInfo.preferences.teachingStyle === style}
                                                onChange={handleParentChange}
                                            />
                                    ...
                                    {["Male", "Female", "Other"].map((gender, index) => (
                                        <div key={index} className="flex items-center gap-2">
                                            <input
                                                ...
                                                name="tutorGender"
                                                value={gender}
                                                checked={parentInfo.preferences.tutorGender === gender}
                                                onChange={handleParentChange}
                                            />
                        ...
                        <div>
                            ...
                            <p className="flex items-center gap-2">
                                <FaGraduationCap /> Children's Grade: {parentInfo.children?.grade || "N/A"}
                            </p>
                            <p className="flex items-center gap-2">
