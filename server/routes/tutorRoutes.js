...
const { createOrUpdateTutorProfile, getTutorProfile, getAllTutors, deleteTutorProfile, getAvailableTutors,getReviews } = require('../controllers/tutorController');
...
//router.get('/:tutorId/reviews', getReviews)
